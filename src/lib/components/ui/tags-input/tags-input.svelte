...
<div
  class={[
    "flex min-h-[40px] w-full flex-wrap place-items-center gap-1 rounded-lg border border-input bg-muted px-1 py-1 disabled:opacity-50 aria-disabled:cursor-not-allowed",
    className,
  ]}
